...
-- -----------------------------------------------------
-- Table `equipmentrentaldb`.`Include`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `equipmentrentaldb`.`Include` ;

CREATE TABLE IF NOT EXISTS `equipmentrentaldb`.`Include` (
  `include_id` INT NOT NULL AUTO_INCREMENT,
  `event_id` INT NOT NULL,
  `sport_event_id` INT NOT NULL,
  ...
  CONSTRAINT `Events.event_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `SportEvents.sport_event_id`
